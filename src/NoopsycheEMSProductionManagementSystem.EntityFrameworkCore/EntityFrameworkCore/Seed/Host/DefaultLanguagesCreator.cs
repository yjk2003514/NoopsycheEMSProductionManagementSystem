...
namespace NoopsycheEMSProductionManagementSystem.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = NoopsycheEMSProductionManagementSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(NoopsycheEMSProductionManagementSystemDbContext context)
        {
            _context = context;
        }
